...
INSERT INTO accounts(owner,
                     ...
                     currency,
                     created_at)
VALUES ($1, $2, $3, $4) RETURNING account_id, owner, balance, currency, created_at
`
...
SELECT account_id, owner, balance, currency, created_at FROM accounts where account_id = $1 limit 1 FOR NO KEY UPDATE
`
...
SELECT account_id, owner, balance, currency, created_at FROM accounts order by account_id LIMIT  $1 OFFSET $2 FOR NO KEY UPDATE
`
...
UPDATE accounts SET balance = $2 WHERE account_id = $1 RETURNING account_id, owner, balance, currency, created_at
`
